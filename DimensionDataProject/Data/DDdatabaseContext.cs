...
namespace DimensionDataProject.Data
{
    public partial class DDdatabaseContext : DbContext
    {
        public DDdatabaseContext()
        {
        }

        public DDdatabaseContext(DbContextOptions<DDdatabaseContext> options)
            : base(options)
        {
        }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. See http://go.microsoft.com/fwlink/?LinkId=723263 for guidance on storing connection strings.
                optionsBuilder.UseSqlServer("Initial Catalog=DDdatabase;Data Source=DESKTOP-F97RQLI\\SQLEXPRESS;Trusted_Connection=true");
            }
        }
